                        ...
                        {artist.albums.map((album, albumIndex) => (
                          <article className="album-card album-card-compact" key={album.title}>
                            <div className="album-cover">
                              <img src={compatibleImageSrc(album.cover)} alt={`${artist.name}《${album.title}》专辑封面`} loading="lazy" decoding="async" />
                ...
                <div className="album-rail" aria-label="收藏专辑，可左右滑动">
                  {aestheticAlbums.map((album) => (
                    <article className="album-card" key={album.title}>
                      <div className="album-cover">
                        <img src={compatibleImageSrc(album.cover)} alt={`${album.artist}《${album.title}》专辑封面`} loading="lazy" decoding="async" />
                ...
                <div className="live-event-groups" aria-label="演唱会与音乐节现场照片">
                  <section className="live-event-group">
                    ...
                    <div className="live-event-pair live-event-pair-portrait">
                      <figure className="live-input-photo">
                        <img src={compatibleImageSrc('/assets/inputs/live-zhang-zhenyue-01.webp')} alt="张震岳全国演唱会现场留影" loading="lazy" decoding="async" />
                        <figcaption><span>01</span> 张震岳全国演唱会</figcaption>
                      </figure>
                      <figure className="live-input-photo">
                        <img src={compatibleImageSrc('/assets/inputs/live-zhang-zhenyue-quanzhou.webp')} alt="张震岳全国演唱会蓝色舞台现场" loading="lazy" decoding="async" />
                  ...
                  <section className="live-event-group">
                    ...
                    <div className="live-event-pair live-event-pair-landscape">
                      <figure className="live-input-photo">
                        <img src={compatibleImageSrc('/assets/inputs/live-simple-life-01.webp')} alt="陈绮贞在广州草莓音乐节的舞台现场" loading="lazy" decoding="async" />
                        <figcaption><span>03</span> 陈绮贞 · 广州草莓音乐节</figcaption>
                      </figure>
                      <figure className="live-input-photo">
                        <img src={compatibleImageSrc('/assets/inputs/live-simple-life-02.webp')} alt="陈绮贞在广州草莓音乐节的夜间舞台现场" loading="lazy" decoding="async" />
                ...
                {aestheticFilms.map((film, index) => (
                  <article className="film-input-card" key={`${film.title}-${index}`}>
                    <div className="film-poster">
                      <img src={compatibleImageSrc(film.poster)} alt={`《${film.title}》电影海报`} loading="lazy" decoding="async" />
            ...
            <section className="training-panel" role="tabpanel" aria-label="训练">
              ...
              <div className="training-gallery" aria-label="我的训练记录">
                <figure className="training-photo training-photo-tall">
                  <img src={compatibleImageSrc('/assets/inputs/training-back.webp')} alt="健身房里的背部训练记录" loading="lazy" decoding="async" />
                  <figcaption><span>01</span> TRAINING DAY</figcaption>
                </figure>
                <figure className="training-photo training-photo-wide">
                  <img src={compatibleImageSrc('/assets/inputs/training-arms.webp')} alt="训练后的身体状态记录" loading="lazy" decoding="async" />
